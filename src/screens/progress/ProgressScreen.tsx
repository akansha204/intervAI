...
const ProgressScreen = () => {
    ...
    const renderStatCard = (value: string | number, label: string, valueColor: string) => (
        <View
            style={[
                {
                    flex: 1,
    ...
    return (
        <ScrollView
            ...
            {/* Header */}
            <View style={{ backgroundColor: colors.Others.white, padding: scale(20) }}>
            ...
            <View
                ...
                {renderStatCard(stats.averageScore, 'Avg Score', colors.Alert.Success[100])}
                {renderStatCard(stats.bestScore, 'Best Score', colors.Alert.Warning[100])}
                {renderStatCard(stats.improvement, 'Improvement', colors.Alert.Success[100])}
            </View>
            ...
            <View style={{ paddingHorizontal: scale(20), marginTop: scale(8) }}>
                ...
                {sessions.length === 0 && (
                    <View style={{ alignItems: 'center', paddingVertical: scale(40) }}>
                        <Text
                            style={[texts.body.large.semibold, { color: colors.Greyscale[500] }]}>
                            No sessions yet
                        </Text>
                        <VSpacer height={8} />
