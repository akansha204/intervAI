...
const FeedbackDetailScreen = () => {
  ...
  const route =
    useRoute<RouteProp<FeedbackDetailRouteParams, 'FeedbackDetail'>>();
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.Greyscale[0] }}>
      ...
      >
        <Text
          style={[texts.body.medium.regular, { color: colors.Others.white }]}
        >
          Your Score
        </Text>
        <VSpacer height={8} />
      ...
      >
        <Text
          style={[texts.body.small.semibold, { color: colors.Greyscale[500] }]}
        >
          Question:
        </Text>
        <VSpacer height={8} />
        <Text
          style={[texts.body.medium.regular, { color: colors.Greyscale[900] }]}
        >
          {question.text}
        </Text>
      </View>
      ...
      >
        ...
        <VSpacer height={8} />
        <Text
          style={[texts.body.small.regular, { color: colors.Greyscale[900] }]}
        >
          {answer}
        </Text>
      </View>
      ...
      >
        ...
        {feedback.strengths.map((strength, index) => (
          <View
            key={index}
            style={{ flexDirection: 'row', marginBottom: scale(8) }}
          >
            <Text
              style={[
