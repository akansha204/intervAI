        ...
        <ScrollView style={{ flex: 1, backgroundColor: colors.Greyscale[0] }}>
            ...
            <View
                ...
                <View
                    ...
                    <Text style={[texts.heading.heading2, { color: colors.Greyscale[900] }]}>
            ...
            <View
                ...
                />
                <TouchableOpacity style={{ paddingVertical: scale(12) }} onPress={handleLogout}>
                    <Text
                        style={[
            ...
            <View style={{ padding: scale(20), alignItems: 'center' }}>
                <Text style={[texts.body.extraSmall.regular, { color: colors.Greyscale[400] }]}>
                    Version 1.0.0
                </Text>
            </View>
        </ScrollView>
